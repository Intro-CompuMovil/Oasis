...
class RepartidorSolicitudHistorialDetallesAdapter (private val context: Context, private val ordenes: List<Order>) : RecyclerView.Adapter<RepartidorSolicitudHistorialDetallesAdapter.RepartidorViewHolder>() {
