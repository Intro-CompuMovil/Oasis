...
class CompradorInicio : AppCompatActivity() {
    ...
    private fun initRecyclerView(categorias: List<Category>) {
        val rvCategories = findViewById<RecyclerView>(R.id.rvCategories)
        val categoryAdapter = CategoryAdapter(this, categorias, this)
    ...
    private fun getCategories() {
        lifecycleScope.launch {
            val productos = FireBaseDataBase().obtenerProductos()
            ...
            if (productos.isNotEmpty()) {
                ...
                AppUtilityHelper.showErrorDialog(this@CompradorInicio, "No se encontraron productos")
            }
        }
    }
}